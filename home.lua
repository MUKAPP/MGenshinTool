...
function onCreate()
    ...
    xpcall(
        function()
            ...
            function 返回底部()
                local scrollYu =
                ObjectAnimator.ofInt(obs_1, "scrollY",
                    { obs_1.scrollY, activity.Height * 0.618 - dp2px(56 - 8) - 状态栏高度 })
                scrollYu.setDuration(512)
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        layout_marginBottom = "16dp",
                                                        {
                                                            ...
                                                            onClick = function(view)
                                                                local intent = Intent(activity,
                                                                    luajava.bindClass("com.androlua.LuaActivity"))
            ...
            floatbutton_newarticle_lay.setLayoutTransition(transitioner)
            floatbutton_newarticle.getParent().setLayoutTransition(transitioner)
            ...
            cv1_lay.setOnTouchListener(
                {
                    onTouch = function(v, n)
                        if tostring(n):find("ACTION_DOWN") then
                            --设置动画插入器，减速
                            ObjectAnimator.ofFloat(xf1, "translationZ", { xf1.translationZ, dp2px(8) }).setDuration(128)
                                .setInterpolator(
                                --设置动画时间
                                    DecelerateInterpolator()
                                ).start()
                        elseif tostring(n):find("ACTION_UP") then
                            ObjectAnimator.ofFloat(xf1, "translationZ", { xf1.translationZ, dp2px(4) }).setDuration(128)
                                .setInterpolator(
                                --设置动画时间
                                    AccelerateInterpolator()
                                ).start()
            ...
            cv2_lay.setOnTouchListener(
                {
                    onTouch = function(v, n)
                        if tostring(n):find("ACTION_DOWN") then
                            --设置动画插入器，减速
                            ObjectAnimator.ofFloat(xf2, "translationZ", { xf1.translationZ, dp2px(8) }).setDuration(128)
                                .setInterpolator(
                                --设置动画时间
                                    DecelerateInterpolator()
                                ).start()
                        elseif tostring(n):find("ACTION_UP") then
                            ObjectAnimator.ofFloat(xf2, "translationZ", { xf1.translationZ, dp2px(4) }).setDuration(128)
                                .setInterpolator(
                                --设置动画时间
                                    AccelerateInterpolator()
                                ).start()
            ...
            function openFloatWeb()
                                            ...
                                            end,
                                            {
                                                ...
                                                },
                                                {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        Elevation = "0",
                                                        onClick = function()
                                                            floatload("https://fsoufsou.com/search?tbn=all&q=" ..
                                                                floatsearch.Text)
                                                            关闭floatsearch()
                                                        end,
                                                        {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        Elevation = "1dp",
                                                        onClick = function()
                                                            floatload("https://m.bbs.mihoyo.com/ys/#/search?keyword=" ..
                                                                floatsearch.Text)
                                                            关闭floatsearch()
                                                        end,
                                                        {
                ...
                floatalpha.ProgressDrawable.setColorFilter(PorterDuffColorFilter(转0x(primaryc),
                ...
                function sethoyojs(url)
                    if url:find("mihoyo%.com") and url:find("interactive%-map") then
                        js =
                        [[
            ...
            for (var i = 0; i<x.length;i++) {
                   x[i].style.display="none";
                    ...
                    elseif url:find("mihoyo%.com") then
  ...
  if ( thisNode != null && thisNode.parentElement != null ) {
                    ...
                    LuaWebChrome(
                        LuaWebChrome.IWebChrine {
                            onProgressChanged = function(view, newProgress)
                                ...
                                lpm.width = newProgress *
                                    ((floatwm.getDefaultDisplay().getWidth() - dp2px(16 * 2)) / 100)
      ...
      activity.Title=furl
            ...
            function sendNotification(notification_title, notification_content, id, name, intent, ongoing, sound,
                                      fullscreen)
                local builder
                --intent = Intent()
            ...
            function mys_signIn()
                ...
                xpcall(function()
                    cookies = JSON.decode(mukactivity.getData("myscookies"))
                end,
                    function(e)
                ...
                function signIn()
                    ...
                    local function next()
                        ...
                        nextTicker.onTick = function()
                            nextTicker.stop()
                            if signed + 1 <= #all_uid then
                                signIn()
                            else
                                printLog("signIn", sign_results)
                                mukactivity.setData("signresult", JSON.encode(sign_results))
                                mukactivity.setData("sign_act_id", act_id)
                                关闭对话框()
                                issigning = false
                                activity.newActivity("tools/signreturn")
                            end
                        end
                        nextTicker.start()
                    end
                    ...
                    Http.get("https://api-takumi.mihoyo.com/event/bbs_sign_reward/info?region=" ..
                        ...
                        xpcall(function()
                            ...
                            Http.get(
                                ...
                                if code ~= 200 then
                                    if code == 427 then
                                        sign_results[#sign_results + 1] = { "账号 " .. nam .. " 签到失败",
                                            "请求失败，短时间内请求过多，请稍后再试", cookie }
                                        next()
                                        return true
                                    end
                                    sign_results[#sign_results + 1] = { "账号 " .. nam .. " 签到失败",
                                        "请求失败，错误码：" .. code, cookie }
                                    next()
                                    return true
                                end
                                ...
                                if is_sign == true then
                                    sign_results[#sign_results + 1] = { nickname ..
                                        "  UID: " .. uid .. " (" .. region_name .. ")",
                                        [[今日奖励: ]] ..
...
签到结果: ]]                                     .. "今天已经签到过啦", cookie }
                                    ...
                                    map.put("Referer",
                                        ...
                                        .. act_id .. "&utm_source=bbs&utm_medium=mys&utm_campaign=icon")
...
签到结果: ]]                                                 .. message, cookie }
                                                ...
                                                if data.success == 1 then
                                                    ...
                                                    加载对话框内容("正在签到: " .. signed .. "/" ..
                                                        #all_uid
                                                        .. "\n需要验证码，正在尝试通过")
                                                    if capacha_challenge and capacha_gt then
                                                        Http.get("https://api.geetest.com/ajax.php?gt=" ..
                                                            capacha_gt ..
                                                            "&challenge=" ..
                                                            capacha_challenge ..
                                                            "&lang=zh-cn&pt=3&client_type=web_mobile&callback=geetest_1663984420850"
                                                            ,
                                                                    ...
                                                                    if validate then
                                                                        ...
                                                                        Http.post("https://api-takumi.mihoyo.com/event/bbs_sign_reward/sign"
                                                                            ...
                                                                            function(code, content)
                                                                                printLog("BBS Sign", "sign", code)
                                                                                if code ~= 200 then
                                                                                    sign_results[#sign_results + 1] = { "账号 "
                                                                                        .. nam .. " 签到失败",
                                                                                        "请求失败，错误码：" ..
                                                                                            code, cookie }
                                                                                    next()
                                                                                ...
                                                                                local content = JSON.decode(content)
                                                                                printLog("BBS Sign", "sign_dump", code,
                                                                                    dump(content))
                                                                                local message = content.message
                                                                                local data = content.data
                                                                                if data then
                                                                                    if content.retcode == 0 and
                                                                                        data.success == 0 then
                                                                                        message = "签到成功"
                                                                                        printLog("BBS Sign",
                                                                                            nickname .. "  UID: " .. uid
...
签到结果: ]]                                                                     .. message, cookie }
                            ...
                            if content.retcode == -100 then
                                sign_results[#sign_results + 1] = { "账号 " .. nam .. " 签到失败",
                                    "登录状态失效(签到的状态检测更加严格)，请重新登录", cookie }
                                next()
                                return true
                            end
                            if content.retcode == -1004 then
                                sign_results[#sign_results + 1] = { "账号 " .. nam .. " 签到失败", "触发签到速度限制，请稍后再试",
                                    cookie }
                                next()
                                return true
                            end
                            sign_results[#sign_results + 1] = { "账号 " .. nam .. " 签到失败",
                                "请求失败，未知错误：" .. dump(content), cookie }
                            next()
                            return true
                        end)
                    end)
                ...
                function getUids()
                    gotuid = gotuid + 1
                    加载对话框内容("正在获取UID: " .. gotuid .. "/" .. #cookies_format)
                    ...
                    local function next()
                        ...
                        nextTicker.onTick = function()
                            nextTicker.stop()
                            if gotuid + 1 <= #cookies_format then
                                getUids()
                            else
                    ...
                    Http.get("https://api-takumi.mihoyo.com/binding/api/getUserGameRolesByCookie?game_biz=hk4e_cn",
                        ...
                        if content.data == nil then
                            sign_results[#sign_results + 1] = { "账号 " .. nam .. " 签到失败", content.message,
                                cookie }
                            next()
                            return true
                        end
                ...
                Http.get("https://bbs-api.mihoyo.com/apihub/api/home/new?cpu=mt6785v/cc&device=Xiaomi%20Redmi%20Note%208%20Pro&gids=2"
                    ...
                    function(code, content)
                        if code ~= 200 then
                            sign_results[#sign_results + 1] = { "全部签到失败", "获取签到信息失败，错误码："
                                .. code }
                            issigning = false
                            mukactivity.setData("signresult", JSON.encode(sign_results))
                            mukactivity.setData("sign_act_id", act_id)
      ...
      activity.Title=web.getTitle():match("(.+) ?%-?%–?") or web.getTitle()]]
                            ...
                            xpcall(
                                function()
                                    activity.startActivity(
                                        intent,
                                        ActivityOptions.makeClipRevealAnimation(view, 0, 0, view.getWidth(),
      ...
      if(scrollState==ScrollState.DOWN) then
       ...
       elseif(scrollState==ScrollState.UP) then
        ...
        --print("停止滚动");
            ...
            function dailyNote()
                                    ...
                                    end,
                                    {
                                        ...
                                        },
                                        {
                                            ...
                                            onClick = function(v)
                                                ...
                                                tidailyNote.stop()
                                                tidailyNote = Ticker()
                                                tidailyNote.Period = tointeger(mukactivity.getData("Note_Time")) * 60 *
                                                    1000
                            ...
                            function(code, content)
                                ...
                                if content.retcode == 0 then
                                    ...
                                    if data.resin_recovery_time == "0" then
                                        ...
                                        strength_time.Text = "将于 " ..
                                            secondtostring(tointeger(data.resin_recovery_time)) .. " 全部恢复"
                                    end
                                    task_num.Text = "每日委托 " ..
                                        data.finished_task_num .. "/" .. data.total_task_num
                                    expedition_num.Text = "探索派遣 " ..
                                        data.current_expedition_num .. "/" .. data.max_expedition_num
                                    ...
                                    if expedition_stime == 0 then
                                        ...
                                        expedition_time.Text = "将于 " ..
                                            secondtostring(tointeger(expedition_stime)) .. " 全部完成"
                                    end
                                    coin_num.Text = "洞天宝钱\n" ..
                                    ...
                                    if data.transformer.obtained then
                                        if data.transformer.recovery_time.reached then
              ...
              function(code, content)
                print(code,content)
                                    ...
                                    memo.Text = "获取失败：错误码 " .. content.retcode ..
            ...
            local tableTheme =
            TableTheme.Builder().tableCellPadding(dp2px(12)).tableBorderColor(转0x(cardbackc)).tableBorderWidth(dp2px(2))
                .tableOddRowBackgroundColor(
                    转0x(cardbackc)
                ).tableEvenRowBackgroundColor(转0x(cardbackc)).tableHeaderRowBackgroundColor(转0x(primaryc) -
                    0x7f000000).build()
            ...
            Markwon.builder(this).usePlugin(
                MarkwonPlugin {
                    configureTheme = function(builder)
                        ...
                        --块代码
                            转0x(cardbackc)
                        ).codeBlockMargin(dp2px(8)).headingBreakHeight(dp2px(12)).headingBreakColor(转0x(primaryc) -
                            0x7f000000).headingTypeface(
                        --块代码内容的前导边距
                        --H1和H2下的刹车高度
                        --H1和H2下刹车的颜色
                            AppFont.粗体
                    ...
                    GlideImagesPlugin.GlideStore {
                        load = function(drawable)
                            ...
                            if link:find("tpic.mukapp.top") then
                                glideUrl =
                                GlideUrl(link,
                                    LazyHeaders.Builder().addHeader("Referer", "https://tanutai.mukapp.top").build())
                            else
                                glideUrl =
                                GlideUrl(
                                    link,
                            ...
                            --.placeholder(BitmapDrawable(loadbitmap("res/loading_image.png")))
                                DrawableTransitionOptions.with(DrawableCrossFadeFactory.Builder(328).setCrossFadeEnabled(true)
                                    .build())
                                ...
                                SimpleTagHandlerImpl(
                                    CallBack {
                                        getSpans = function(configuration, renderProps, tag)
                                            ...
                                            if tag.attributes().get("color") ~= nil and
                                                tag.attributes().get("color") ~= "" then
                        ...
                        onBindViewHolder = function(holder, position, payload)
                            ...
                            elseif ta_article_adp.getItemViewType(position) == 3 then
                                ...
                                view.comment_count.getParent().onClick = function()
                                    activity.newActivity("tanutai/articles", { ta_article_data[position], true })
                                    function articleInfoChanged(up, down, voting, follower, is_following)
                                        ...
                                        ta_article_data[position].follower_count = follower
                                        ta_article_data[position].relationships.is_following = is_following
                                ...
                                view.vote_up_count.getParent().onClick = function(v)
                                    ...
                                    ta_article_data[position].relationships.l_voting = ta_article_data[position].relationships
                                        .voting

                                    if ta_article_data[position].relationships.voting == "up" then
                                        local oldDatas = ta_article_data

                                        ta_article_data[position].vote_up_count = ta_article_data[position].vote_up_count
                                            - 1
                                        ...
                                        tanutai.articlesVoters(
                                            ...
                                            function(content)
                                                if content.code ~= 0 then
                                                    ...
                                                    ta_article_data[position].vote_down_count = ta_article_data[position
                                                        ].l_vote_down_count
                                                    ta_article_data[position].relationships.voting =
                                    ...
                                    elseif ta_article_data[position].relationships.voting == "down" then
                                        ta_article_data[position].vote_up_count = ta_article_data[position].vote_up_count
                                            + 1
                                        ta_article_data[position].vote_down_count = ta_article_data[position].vote_down_count
                                            - 1
                                    else
                                        ta_article_data[position].vote_up_count = ta_article_data[position].vote_up_count
                                            + 1
                                    ...
                                    tanutai.articlesVoters(
                                        ...
                                        function(code, content)
                                            ...
                                            ta_article_data[position].vote_up_count = ta_article_data[position].l_vote_up_count
                                            ta_article_data[position].vote_down_count = ta_article_data[position].l_vote_down_count
                                            ta_article_data[position].relationships.voting = ta_article_data[position].relationships
                                                .l_voting
                                            --ta_article_adp.notifyDataSetChanged()
                                            ta_article_adp.notifyItemChanged(position)
                                        end
                ...
                ObservableScrollViewCallbacks {
                    ...
                    onScrollChanged = function(scrollY, firstScroll, dragging)
                        ...
                        if tarv1_lPos ~= tarv1_glm.findLastVisibleItemPosition() + 1 then
                            ...
                            if (tarv1_lPos == ta_article_adp.getItemCount()) and tarv1_lPos ~= 3 then
                                tarefresh1.setProgressViewOffset(true, 状态栏高度 + dp2px(56 - 8),
                                    screenY - 导航栏高度 - dp2px(56 + 64 + 16))
                                获取文章()
                            else
                                tarefresh1.setProgressViewOffset(true, 状态栏高度 + dp2px(56 - 8),
                                    状态栏高度 + dp2px(56 - 8 + 48))
                    ...
                    onUpOrCancelMotionEvent = function(scrollState)
                        if (scrollState == ScrollState.DOWN) then
                            ...
                            控件可见(floatbutton_newarticle_lay.getChildAt(0))
                            控件可见(floatbutton_newarticle_lay.getChildAt(2))
                            控件可见(floatbutton_newarticle_lay.getChildAt(4))
                        elseif (scrollState == ScrollState.UP) then
                            if tarv1_lst >= 5 then
                                --print("向上滚动");
                                translationUp = ObjectAnimator.ofFloat(tatopbar, "Y",
                                    { tatopbar.getY(), dp2px(-56) - 状态栏高度 - 2 })
                                translationUp.setInterpolator(DecelerateInterpolator())
                                translationUp.setDuration(256)
                                translationUp.start()

                                --MFBhide(floatbutton_newarticle)
                                控件隐藏(floatbutton_newarticle_lay.getChildAt(0))
                                控件隐藏(floatbutton_newarticle_lay.getChildAt(2))
                                控件隐藏(floatbutton_newarticle_lay.getChildAt(4))
                            else
                                --print("向下滚动2");
                                translationUp = ObjectAnimator.ofFloat(tatopbar, "Y", { tatopbar.getY(), 0 })
                                translationUp.setInterpolator(DecelerateInterpolator())
            ...
            function 获取文章()
                if tarefresh1_refreshing ~= true then
                    ...
                    tanutai.articles(
                        ta_article_page,
                        "-update_time",
                        "user,voting,topics,is_following",
                        function(content)
                            if ta_article_page == 1 then
                                ta_article_data = {}
                                last_ta_art_count = 0
                            ...
                            if ta_article_page ~= 1 then
                                ta_article_adp.notifyItemRangeInserted(ta_article_adp.getItemCount(),
                                    #ta_article_data + 1)
                            else
                                ta_article_adp.notifyDataSetChanged()
                            end
            ...
            function newCaptcha(view)
                tanutai.captcha(
                    function(content)
                        Glide.with(activity).load(base64ToBytes(content.data.captcha_image:match("%,(.+)"))).skipMemoryCache(true)
                            .diskCacheStrategy(
                    ...
                    function(content)
                        ...
                        if content.code ~= 0 then
                            for i, v in pairs(content.errors) do
                                ...
                                if v:match("验证码") then
                                    控件可见(tacaptcha_p)
                                    Glide.with(activity).load(base64ToBytes(content.captcha_image:match("%,(.+)"))).skipMemoryCache(true)
                                        .diskCacheStrategy(
                                            DiskCacheStrategy.NONE
                                        ).into(tacaptchaimg)
