mukactivity = {
    setData = function(string_name, sth_value, string_mode)
        this.setSharedData(string_name, sth_value)
    end,
    setDataR = function(string_name, sth_value, string_mode)
        if this.getSharedData(string_name) == nil then
            this.setSharedData(string_name, sth_value)
        end
    end,
    getData = function(string_name, string_mode, sth_notresult)
        if this.getSharedData(string_name) then
            return this.getSharedData(string_name)
