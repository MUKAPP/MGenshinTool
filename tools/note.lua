                    ...
                    function(code, content, _, header)
                        ...
                        if content.retcode == 0 then
                            ...
                            if data.resin_recovery_time == "0" then
                                ...
                                strength_time = "将于 " .. secondtostring(tointeger(data.resin_recovery_time)) ..
                                    " 全部恢复"
                            end
                            local task_num = "每日委托 " .. data.finished_task_num .. "/" .. data.total_task_num
                            local expedition_num = "探索派遣 " ..
                            ...
                            data_[#data_ + 1] = { "error", "获取失败：错误码 " ..
                                content.retcode .. "；错误信息 " .. content.message,
                                nickname .. "  UID: " .. uid .. " (" .. region_name .. ")" }
                            更新adp()
                        end
                    end)
