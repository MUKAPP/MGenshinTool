  ...
  rank4_alltext)
    xpcall(
        function()
            ...
            if rank5_arm_v then
                pieChartView.addItemType(
                    PieChartView.ItemType("五星武器：" .. (rank5 - rank5_people), rank5 - rank5_people,
                        转0x(color_five_star_arm))
                )
            end
            ...
            if rank4_arm_v then
                pieChartView.addItemType(
                    PieChartView.ItemType("四星武器：" .. rank4 - rank4_people, rank4 - rank4_people,
                        转0x(color_four_star_arm))
                )
            end
    ...
    gray)
            ...
            xpcall(
                function()
                    ...
                    local json = io.open(activity.getExternalFilesDir("").getAbsolutePath() .. "/user/gacha_export.tmp")
                        :read("*a")
          ...
          if newtable[i].id==nil
            ...
            newtable[i].id=tostring(noid)
                    ...
                    for i, v in pairs(tab) do
                        ...
                        for i2, v2 in ipairs(v.content) do
        ...
        mode=1
          ...
          content=tab.result[i][2]
                        ...
                        if total_c ~= 0 then
                                ...
                                if rank == 5 then
                                    ...
                                    if name ~= "角色活动祈愿" then
                                        ...
                                        if name:find("角色") then
                                            ...
                                            if nname == "迪卢克" or nname == "莫娜" or nname == "七七" or
                                                nname == "琴" then
                                                last_iscz = true
                                            ...
                                            elseif nname == "提纳里" then
                                                ...
                                                if tointeger(sdf.parse(time).getTime() / 1000)
                                                    ...
                                                    >= tointeger(sdf.parse("2022-08-24 11:00:00").getTime() / 1000) then
                                                    last_iscz = false
                                                else
                                                    last_iscz = true
                                                    iscz_zt = '<font color="' .. gray .. '">[歪'
                                            ...
                                            elseif nname == "刻晴" then
                                                ...
                                                if tointeger(sdf.parse(time).getTime() / 1000)
                                                    ...
                                                    and tointeger(sdf.parse(time).getTime() / 1000)
                                                    >= tointeger(sdf.parse("2021-02-17 18:00:00").getTime() / 1000) then
                                                    last_iscz = false
                                                else
                                                    last_iscz = true
                                                    iscz_zt = '<font color="' .. gray .. '">[歪'
                                        ...
                                        five_star ..
                                            '<font color="' ..
                                            rank5_color .. '">' .. nname .. "</font>" .. iscz_zt .. total_ .. "]</font> "
                                    end
                            ...
                            local total_text = ""
                            total_text = total_text .. '总计 <font color="' ..
                                primaryc .. '">' .. total_c .. "</font> 抽"
                            if average == "无" then
                                total_text = total_text .. "<br>未抽出过五星"
                            else
                                total_text = total_text ..
                                    '<br>平均 <font color="' .. primaryc .. '">' .. average .. "</font> 抽一个五星"
                            end
                            total_text = total_text ..
                                '<br>已累积 <font color="' .. primaryc .. '">' .. no_rank5 .. "</font> 抽未出五星"
                            total_text = total_text ..
                                '<br>下一抽出五星概率 <font color="' ..
                                primaryc .. '">' .. rank5_prob .. "</font>"
                            ...
                            if rank5 ~= 0 then
                                ...
                                info_text ..
                                    '<font color="' ..
                                    color_five_star .. '">五星：' .. rank5 .. " 占 " .. rank5b .. "</font>"
                            end
                            if rank4 ~= 0 then
                                if info_text ~= "" then
                                ...
                                info_text ..
                                    '<font color="' ..
                                    color_four_star .. '">四星：' .. rank4 .. " 占 " .. rank4b .. "</font>"
                            end
                            if rank3 ~= 0 then
                                if info_text ~= "" then
                                    info_text = info_text .. "<br>"
                                ...
                                info_text = info_text ..
                                    '<font color="#3196f3">三星：' .. rank3 .. " 占 " .. rank3b .. "</font>"
                            end
