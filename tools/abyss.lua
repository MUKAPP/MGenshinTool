...
function onCreate()
    ...
    onBindViewHolder=function(holder,position)
      ...
      if viewType==1 then
       ...
       elseif viewType==2 then
        ...
        TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(view.constellations1,8,12,2,TypedValue.COMPLEX_UNIT_SP);
        TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(view.constellations2,8,12,2,TypedValue.COMPLEX_UNIT_SP);
      end
    end,
  }))
  ...
  jc.setOnPageChangeListener(PageView.OnPageChangeListener{
    ...
    onPageSelected=function(v)
      ...
      pageNow=v+1
      if pageNow==2 and a2t==nil
        attendanceRate=attendanceRate_p
        adp2.notifyDataSetChanged()
        a2t=true
      end
      if pageNow==3 and a3t==nil
