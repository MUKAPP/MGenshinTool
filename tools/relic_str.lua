...
btn1.onClick = function()
  ...
  ViewAnimator.animate({btn1.getParent()}).scale({1, 0.9, 1}).interpolator(OvershootInterpolator()).duration(1600).onStop(
    {
      onStop = function()
        强化(20)
      end
...
btn2.onClick = function()
  ...
  ViewAnimator.animate({btn2.getParent()}).scale({1, 0.9, 1}).interpolator(OvershootInterpolator()).duration(1600).onStop(
    {
      onStop = function()
        强化(4)
      end
...
for i,v in ipairs(relic_all) do
  if v.maxStar~=5 then
    table.remove(relic_all,i)
  end
end
...
function 新圣遗物()
  ...
  imgUrl = "https://pan.mukapp.top/onedrive/genshin_artifact-main/src/images/artifacts"
